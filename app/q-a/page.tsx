...
export default function QAPage() {
    const faqs = [
        ...
        },
        {
            ...
            a: "Yes! Children are welcome to join us for both the ceremony and the reception. We kindly ask that parents supervise their little ones throughout the day."
        }
